...
// TODO: use type param
public class ElementKeySerializationSchema implements SerializationSchema<Element<Object, Object>> {
	...
	public ElementKeySerializationSchema(String topic, String serializerClassNames) {
		super();
		this.topic = topic;
	...
	public byte[] serialize(Element<Object, Object> element) {
		...
		return this.serializer.serialize(this.topic, element.getKey());
	}
